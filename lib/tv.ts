...
// Seconds each HOUSE slide holds on a brand-new screen — the Brew Loop ad and the
// "advertise on this screen" card. 15s, the same as
...
//
// The TV player carries its own copy (HOUSE_SLIDE_SECONDS in app/tv/TvPlayer.tsx) for
